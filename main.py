...
def extract_image(style_image):
    ...
    content = plt.imread("leopard.jpg")
    ...
    """Resizing the images"""
    new_content1 = change_size("leopard.jpg")
...
def display_image(img, training_step):
    if len(list(np.shape(img))) > 3:
        ...
        plt.imsave("stylised_image4.jpg", img)
        plt.show()
...
if __name__ == '__main__':
    new_image = tf.Variable(change_size("leopard.jpg"))
    ...
    style1 = plt.imread("style.jpg")
    style2 = plt.imread("design1.jpg")
    style3 = plt.imread("design.jpg")
    ...
    if choice == "style1":
        new_content, new_style = extract_image("style.jpg")
        content_features = extractor.features(new_content)["content"]
        style_features = extractor.features(new_style)["style"]

    elif choice == "style2":
        new_content, new_style = extract_image("design1.jpg")
        content_features = extractor.features(new_content)["content"]
        style_features = extractor.features(new_style)["style"]

    elif choice == "style3":
        new_content, new_style = extract_image("design.jpg")
        content_features = extractor.features(new_content)["content"]
        style_features = extractor.features(new_style)["style"]
